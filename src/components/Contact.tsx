...
const ContactForm = styled(Paper)(({ theme }) => ({
	...
	background:
		"linear-gradient(180deg, rgba(255,255,255,0.98) 0%, rgba(255,249,245,0.98) 100%)",
	borderRadius: "28px",
						...
						>
							<ContactForm>
								...
								<Typography sx={{ color: "text.secondary", mb: 3 }}>
									Share your event details and we will help you create something
									beautiful, thoughtful, and made just for the occasion.
								</Typography>
							...
							>
								...
								<ContactInfo>
									<img
										...
										alt="Location"
									/>
									<Typography color="#5A3E22">San Antonio, TX</Typography>
								</ContactInfo>
								<ContactInfo>
									<img src="/images/email-part-2-svgrepo-com.svg" alt="Email" />
									<Typography color="#5A3E22">
