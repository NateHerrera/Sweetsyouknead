	...
	customCakes: {
		...
		items: [
			...
			},
			{
				...
				description:
					"Strawberry cake with buttercream frosting, strawberry filling, royal icing flowers, and hand piped decorations",
			...
			},
			{
				name: "Carrot Cake",
				description:
					"Carrot cake with cream cheese frosting, walnuts, carrot sprinkles, and gold sign",
	...
	customCupcakes: {
		...
		items: [
			...
			},
			{
				...
				description:
					"Sugar-free chocolate cupcakes with PB Fit frosting, topped with a zero-sugar peanut butter cup",
...
const Menu: React.FC = () => {
	...
	return (
      ...
      `}</style>
			...
			>
				Explore Precious Sol Bakery's handcrafted cakes, cupcakes, breads, and
				desserts made with care in San Antonio, TX. Each item is baked fresh
				with quality ingredients to bring you a polished, homemade touch for
				birthdays, showers, and special celebrations.
				<br></br>
				We also offer custom orders, so if you do not see exactly what you're
				looking for, contact us to discuss your special requirements and we'll
			...
			<Box sx={{ textAlign: "center", marginTop: { xs: 4, md: 6 } }}>
				...
				>
					Don't see exactly what you're looking for? We love creating custom
					orders! Contact us to discuss your special requirements and we'll make
