...
const galleryData = [
	{
		...
		title: "Galaxy Cake",
		description:
			"6 inch vanilla cake with american buttercream frosting, edible glitter, and painted stars",
	...
	},
	{
		...
		description:
			"Strawberry and vanilla cake with buttercream, fondant animals, and royal icing flowers",
	...
	},
	{
		...
		description:
			"Chocolate espresso cake with raspberry filling, buttercream frosting, and gold accents",
	...
	},
	{
		...
		description:
			"Vanilla cake with buttercream frosting, fondant Snoopy and Woodstock, and edible pearls",
	...
	},
	{
		...
		description:
			"Vanilla cake with strawberry filling, buttercream frosting, and strawberry slices",
	...
	},
	{
		...
		description:
			"Vanilla cake with buttercream frosting, Barbie doll, and edible pearls",
	...
	},
	{
		...
		description:
			"Chocolate cake with chocolate buttercream, chocolate shavings, raspberry filling, and raspberry fruit",
	...
	},
	{
		...
		description:
			"Strawberry and vanilla cake with buttercream, fondant crawfish, corn, and potatoes",
	...
	},
	{
		...
		description:
			"Personalized spring cake with custom decorations and royal icing flowers",
	...
	},
	{
		...
		description:
			"Chocolate ganache glazed cake with white chocolate decorations",
	...
	},
	{
		...
		description:
			"Strawberry and vanilla cake, with buttercream snowflakes, and sanding sugar",
	...
	},
	{
		...
		description:
			"Moist strawberry cupcakes with strawberry frosting, Nilla Wafers, and a half strawberry",
	...
	},
	{
		...
		description:
			"Fun fiesta buttercream colors on rum-infused cupcakes, gold decorations, and chocolate strawberries",
	...
	},
	{
		...
		description:
			"Sugar-free chocolate cupcakes with PB Fit frosting, topped with a zero-sugar Reese's cup",
	...
	},
	{
		...
		title: "Kolaches",
		description:
			"Soft milk bread with cheddar cheese or jalapeño cheddar sausage",
	...
	},
	{
		...
		description:
			"Crumble topping and icing glaze with sweet-tart guava flavor and fruit variations like strawberry, blueberry, and raspberry",
	...
	},
	{
		...
		title: "Guava Muffins",
		description:
			"Muffins with crumble topping and icing glaze, sweet-tart guava flavor, and fruit variations like strawberry, blueberry, and raspberry",
	...
	},
	{
		...
		description:
			"Jumbo blueberry muffins with blueberries and streusel topping",
	...
	},
	{
		...
		description:
			"Chocolate-covered strawberries for birthdays, Mother's Day, Valentine's Day, and every sweet occasion.",
...
const GalleryCardMedia = styled(CardMedia)(({ theme }) => ({
	...
	"&::before": {
		...
		bottom: 0,
		background:
			"linear-gradient(45deg, rgba(255, 182, 193, 0.1), rgba(168, 224, 99, 0.1))",
		opacity: 0,
		...
		<GalleryContainer>
			<Container maxWidth="lg">
				<Box textAlign="center" mb={6}>
					...
					>
						Here’s a look at handcrafted cakes, cupcakes, pastries, and desserts
						from Precious Sol Bakery in San Antonio.
						<br />
						<br />
						Explore our collection of custom cakes, wedding cakes, birthday
						cakes, and bakery treats made with love and attention to detail.
					</Typography>
				</Box>
						...
						<Grid item xs={6} sm={6} md={4} lg={3} key={item.id}>
							<GalleryCard onClick={() => handleImageClick(item)}>
								<Box sx={{ position: "relative" }}>
									<GalleryCardMedia image={item.image} title={item.title} />
